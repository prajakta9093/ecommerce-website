...
const Hero = () => {
  return (
    <section className="flex flex-col sm:flex-row border min-h-[calc(100vh-100px)]">
      ...
      <div className="w-full sm:w-1/2 flex items-center justify-center py-8">
        <div className="text-gray-700 px-6 sm:px-10 max-w-md">
          ...
          <a
            ...
            className="text-xl sm:text-2xl lg:text-3xl font-bold mb-2 text-gray-900 hover:text-purple-600 transition inline-block"
          >
            @gaurishirkee
          </a>
          ...
          <Link to="/shop">
            <button className="mt-5 bg-purple-600 text-white px-5 py-2 text-xs rounded hover:bg-purple-700 transition">
              Shop Now
            </button>
          </Link>
        </div>
      ...
      {/* Image Side */}
      <div className="w-full sm:w-1/2 flex items-center justify-center bg-purple-50 p-6">
        <img
          src={dp}
          alt="Gauri Shirke"
